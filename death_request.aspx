...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td class="auto-style7">
                <asp:TextBox ID="txtappliaddress" runat="server"></asp:TextBox>
            </td>
            <td class="auto-style11">&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtdecage" runat="server"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="auto-style3">&nbsp;</td>
        ...
        <tr>
            ...
            <td class="auto-style7">
                <asp:TextBox ID="txtdecplace" runat="server"></asp:TextBox>
            </td>
            <td class="auto-style11">&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        ...
        <tr>
            ...
            <td class="auto-style7">
                <asp:TextBox ID="txtdecreason" runat="server"></asp:TextBox>
            </td>
            <td class="auto-style11">&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
