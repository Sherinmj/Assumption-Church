<%@ Page Title="" Language="C#" MasterPageFile="~/mainadmin.Master" AutoEventWireup="true" CodeBehind="family_members.aspx.cs" Inherits="Assumption_Church.family_members" %>
    ...
    <table class="auto-style1">
        ...
        <tr>
            ...
            <td class="auto-style3">
                <asp:Label ID="Label1" runat="server" style="font-weight: 700" Text="FAMILY MEMBERS"></asp:Label>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="auto-style3">
                <asp:TextBox ID="txtfamilyid" runat="server" OnTextChanged="txtfamilyid_TextChanged"></asp:TextBox>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
