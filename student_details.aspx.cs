...
namespace ChurchWebPortal
{
    public partial class student_details : System.Web.UI.Page
    {
        ...
        {
            getcon();
            String ins = "insert into student_details values('" + txtname.Text + "','" + txtdob.Text + "','" + txtstandard.Text + "','" + DropDownList1.SelectedItem.ToString() + "','" + txthalfyr.Text + "','" + txtfinalyr.Text + "')";
